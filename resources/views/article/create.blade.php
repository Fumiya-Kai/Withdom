...
<div class="container mt-5 py-5">
  ...
  {{ Form::open(['route' => 'article.store', 'method' => 'POST', 'class' => 'mt-5']) }}
    ...
    <div class="row mt-3">
      <a href="{{ route('team.show', $teamId) }}" class="btn btn-secondary col-2 col-md-1 offset-7 offset-md-6">戻る</a>
      {{ Form::submit('作成', ['class' => 'submit btn btn-warning ms-3 col-2 col-md-1']) }}
    </div>
  {{ Form::close() }}
</div>
